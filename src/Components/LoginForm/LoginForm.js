...
class LoginForm extends Component {
  ...
  render() {
    return (
      <div>
        {this.state.register ? (
          <Register closeLogin={this.props.closeLogin} />
        ) : (
          <Body>
            <TopBar>
              <h4>log in</h4>
            ...
            <Link to="/dashboard">
              <AuthButton onClick={this.handleSubmit}>login</AuthButton>
            </Link>

            <RegisterQ>
              need an account?
              <AuthButton onClick={this.toggleRegister}>register</AuthButton>
            </RegisterQ>
          </Body>
        )}
      </div>
