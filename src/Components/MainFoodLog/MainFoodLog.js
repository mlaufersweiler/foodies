      ...
      <div>
        ...
        <Body>
          <TopSection>
            ...
            <AddButton to="addmeal" onClick={this.props.clearCurrentMeal}>
              +
            </AddButton>
          </TopSection>
                ...
                return (
                  <Meal key={meal.meal_id}>
                    <MealHeader>
                      <MealLink
                        to="/dayview"
                        onClick={() => this.props.setCurrentMeal(meal)}
                      >
                        {meal.date}
                      </MealLink>
                    </MealHeader>
                    <Nutrients>
                      ...
                      <p>
                        <span>protein</span>
                        <br />
                        {meal.protein.toFixed(2)} g
                      </p>
                      <p>
                        <span>fat</span>
                        <br />
                        {meal.fat.toFixed(2)} g
                      </p>
                      <p>
                        <span>carbs</span>
                        <br />
                        {meal.carbs.toFixed(2)} g
                      </p>
                      <p>
                        <span>fiber</span>
                        <br />
                        {meal.fiber.toFixed(2)} g
                      </p>
                      <p>
                        <span>sugar</span>
                        <br />
                        {meal.sugar.toFixed(2)} g
                      </p>
                    </Nutrients>
                  </Meal>
                );
...
export default connect(
  mapStateToProps,
  { setCurrentFood, setCurrentMeal, setMealsArray, clearCurrentMeal }
)(FoodLog);
